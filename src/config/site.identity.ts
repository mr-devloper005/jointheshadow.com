export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'jointheshadow',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Jointheshadow',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'jointheshadow.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://jointheshadow.com',
